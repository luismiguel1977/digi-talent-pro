// Digi Talent Pro Mobile App Logic
...
class DigiTalentApp {
    ...
    startQuestions() {
        ...
        this.currentEvaluation = {
            ...
            questions: [
                ...(formData.get('hasExperience') === 'yes' ? this.questions.experienced :
                    formData.get('hasExperience') === 'other' ? this.questions.other_sector :
                        this.questions.rookie),
                ...this.questions.psychology // Add HR questions to all flows
            ],
            currentQuestionIndex: 0,
            answers: [],
            score: 0,
            observation: {}, // For remote check
            coachability: null // For live test
        };
    ...
    nextQuestion() {
        ...
        if (currentIdx < this.currentEvaluation.questions.length - 1) {
            ...
            this.showScreen('observation'); // Go to observation before finishing
        }
    }
    ...
    finishCoachability(result) {
        this.currentEvaluation.coachability = result; // 'positive', 'neutral', 'negative'
            ...
            <div class="detail-card">
                ...
                <div class="detail-section">
                    ...
                    <p class="coach-result ${ev.coachability}">
                        ${ev.coachability === 'positive' ? '✅ Positivo: Acepta y corrige' :
                ev.coachability === 'negative' ? '❌ Negativo: Se defiende' : '😐 Neutral'}
                    </p>
                </div>
